...
function initWithDebug() {
  ...
  setInterval(checkForPurchase, 15000); // Check every 15 seconds
      ...
      var chatbotID = "kræftensbekæmpelse";
      ...
      function sendMessageToIframe() {
        ...
        headerLogoG: "https://raw.githubusercontent.com/DialogIntelligens/image-hosting/master/chatbot_logo/logo-1759226649007.png",
        messageIcon: "https://raw.githubusercontent.com/DialogIntelligens/image-hosting/master/chatbot_message_icon/logo-1759226927473.png",
        themeColor: "#c82e2c",
  ...
  function trackChatbotOpen() {
    ...
    .catch(function(error) {
      ...
      function showPopup() {
        ...
        const popupText = "Jeg kan besvare spørgsmål om kræft og hjælpe dig rundt";
