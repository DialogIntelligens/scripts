...
setInterval(checkForPurchase, 15000); // Check every 15 seconds
    ...
    function sendMessageToIframe() {
      ...
      leadGen: "%%",
      leadMail: "kontakt@fynspsykologpraksis.dk",
      leadField1: "Navn",
      leadField2: "Tlf",
  ...
  aiMessageTextColor: "#000000",
      ...
      titleG: "Stil dine spørgsmål her!",
...
function trackChatbotOpen() {
  ...
  .catch(function(error) {
    ...
    function showPopup() {
      ...
      const popupText = "Jeg hjælper med generelle spørgsmål og evt. psykologmatch.";
