...
setInterval(checkForPurchase, 15000); // Check every 15 seconds
    ...
    var chatbotHTML = `
      <div id="chat-container">
        ...
        <button id="chat-button">
          <img src="https://raw.githubusercontent.com/DialogIntelligens/image-hosting/master/sverige2.png" alt="Support agent" />
        </button>
    ...
    function sendMessageToIframe() {
      ...
      headerLogoG: "https://raw.githubusercontent.com/DialogIntelligens/image-hosting/master/chatbot_logo/logo-1757506452439.png",
      messageIcon: "https://raw.githubusercontent.com/DialogIntelligens/image-hosting/master/chatbot_message_icon/logo-1758108027036.png",
      themeColor: "#2e2e2e",
...
function trackChatbotOpen() {
  ...
  .catch(function(error) {
    ...
    function showPopup() {
      ...
      const popupText = "Jag kan rekommendera viner, svara på frågor och hitta ordrar🍷";
