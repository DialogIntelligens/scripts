...
function incrementPageCount() {
  ...
  count++;
  setCookie("pageCount", count.toString(), 30, ".bodylab.fi");
}
...
onDOMReady(function() {
  ...
  function showPopup() {
    ...
    if (!userHasVisited) {
      setCookie("userHasVisited", "true", 1, ".bodylab.fi");
      messageBox.innerHTML = "Hei, olen AI Buddy! Voin suositella tuotteita, vastata kysymyksiin ja laatia ruokavaliosuunnitelmia💪 <span id=\"funny-smiley\">😊</span>";
    } else {
      messageBox.innerHTML = "Hei, olen AI Buddy! Voin suositella tuotteita, vastata kysymyksiin ja laatia ruokavaliosuunnitelmia💪 <span id=\"funny-smiley\">😄</span>";
    }
    ...
    popupCount++;
    setCookie("popupCount", popupCount.toString(), 1, ".bodylab.fi");
    var currentTime = new Date().getTime();
    setCookie("popupLastShown", currentTime.toString(), 1, ".bodylab.fi");
