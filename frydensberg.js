document.addEventListener('DOMContentLoaded', function() {
  ...
  function initChatbot() {
    ...
    function sendMessageToIframe() {
      ...
      statestikAPI: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/2077677d-7086-4838-a23a-6a7012480358",
      SOCKET_SERVER_URL: "https://den-utrolige-snebold.onrender.com/",
      apiEndpoint: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/7134e8ab-6e70-476a-8965-132a17bcfb7e",
      fordelingsflowAPI: "",
      flow2Key: "",
      flow2API: "",
      flow3Key: "product",
      ...
      leadGen: "%%",
      leadMail: "kontor@frydensberg.dk",
      leadField1: "Navn",
    ...
    function showPopup() {
      ...
      const popupText = "Hey! 😎 Er du på jagt efter info? Bare spørg løs, jeg er klar til at hjælpe dig! 🔥 ";
