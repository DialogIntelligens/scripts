document.addEventListener('DOMContentLoaded', function() {
  ...
  function initChatbot() {
    ...
    function sendMessageToIframe() {
      ...
      statestikAPI: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/a74ee384-4503-47cb-90bb-87542767d18d",
      apiEndpoint: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/02f5f2ae-f392-4eb6-b81c-aa5d68397ded",
      fordelingsflowAPI: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/1cca0739-7657-4be7-92c8-2c1ed5340e7d",
      flow2Key: "",
      flow2API: "",
      flow3Key: "product",
      flow3API: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/9bf338a5-06b1-4d32-bc84-1ab908871882",
      flow4API: "",
      flow4Key: "",
    ...
    function showPopup() {
      ...
      if (!userHasVisited) {
        ...
        messageBox.innerHTML = `Har du brug for hjælp til at vælge dit kød? Eller en anbefaling? <span id="funny-smiley">😊</span>` ;
      } else {
