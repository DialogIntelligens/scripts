  ...
  function initChatbot() {
    ...
    function showPopup() {
      ...
      if (!userHasVisited) {
        ...
        messageBox.innerHTML = `Har du brug for hjælp? Jeg kan anbefale fag og svare på spørgsmål Jeg kan anbefale fag og svare på spørgsmål <span id="funny-smiley">😊</span>`;
      } else {
