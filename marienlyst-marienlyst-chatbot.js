document.addEventListener('DOMContentLoaded', function() {
  ...
  if (urlFlag === 'open') {
    ...
    function sendMessageToIframe() {
      ...
      fordelingsflowAPI: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/0ab42b01-a416-47c6-9be4-7b4789c20b13",
      flow2Key: "product",
      flow2API: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/fdc86c50-8928-4e91-b9a3-eaef9e0249d0",
      flow3Key: "product",
      flow3API: "",
      flow4API: "",
      flow4Key: "",
      ...
      headerLogoG: "https://raw.githubusercontent.com/DialogIntelligens/image-hosting/master/chatbot_logo/logo-1748970662647.png",
      messageIcon: "",
      themeColor: "#49868f",
      headerTitleG: " ",
      ...
      titleG: "Marienlyst Strandhotel's Virtuelle Assistent",
