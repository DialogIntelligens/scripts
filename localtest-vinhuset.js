...
function trackChatbotOpen() {
  ...
  .catch(function(error) {
    ...
    function showPopup() {
      ...
      const popupText = "Jeg kan anbefale vine, besvare spørgsmål og se ordrer🍷Jeg kan anbefale vine, besvare spørgsmål og se ordrer🍷Jeg kan anbefale vine, besvare spørgsmål og se ordrer🍷Jeg kan anbefale vine, besvare spørgsmål og se ordrer🍷;;
