window.onload = function() {
  ...
  // The rest of your script for the chat window and message handling
  ...
  // Additional logic for chat toggling, iframe resizing, etc.
  ...
  // Speech balloon management logic
  manageSpeechBalloon();
  ...
  function manageSpeechBalloon() {
    ...
    // Logic for managing the speech balloon display
  }
};
