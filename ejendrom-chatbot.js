document.addEventListener('DOMContentLoaded', function() {
  ...
  function initChatbot() {
    ...
    function sendMessageToIframe() {
      ...
      titleG: "Ejendrøm's AI Drømmer",
      firstMessage: "Hej! Spørg mig om boliger, vurdering, eller få hjælp til at finde den rette bolig for dig 🏠😊",
    ...
    function showPopup() {
      ...
      if (!userHasVisited) {
        ...
        messageBox.innerHTML = `Har du brug for hjælp med boliger, vurdering, eller til at finde den rette bolig for dig? <span id="funny-smiley">😊</span>` ;
      } else {
