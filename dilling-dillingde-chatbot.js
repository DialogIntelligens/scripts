function initChatbot() {
  ...
  function sendMessageToIframe() {
    ...
    var messageData = {
      ...
      dillingColors: "Aqua, blue, Aprikot, Arktik, Blau, Arktik, Blau/natur, Aubergine, Azurblau, Baumrinde, Beige, Beige, meliert, Beige/navy, Bestäubtes, Schwarz, Birne, Birne/natur, Blau, Blau, meliert, Blaugrau, meliert, Blush, Bordeaux, Braun, Braun, meliert, Braunes, Karomuster, Bubblegum, Burgunderrot, Cappuccino/Beige, Carreaux, bleu, marine, Croissant, Donnerblau, Dschungelgrün, Dunkelblau, Dunkelbraun, Dunkelgrau, meliert, Dunkelgrün, Dunkelgrün, meliert, Dunkelnavy, Dunkelrosa, Dunkelrot, Dunkle, Kirsche, Dunkle, Koralle, Dunkles, Lavendel, Dunkelmuskat, Eierlikör, Eisblau, Elfenbein, Erdbeer-Milchshake, Erdbeerrot, Feige, Flieder, Frappé, Frostblau, Fuchsia, Gedecktes, rosa, Grau, Grau, gestreift, Grau, meliert, Grau, meliert, mit, Streifen, Graugrün, Granatapfel, Granatapfel/erdbeer-Milchshake, Granatapfel/nordisches, Blau/natur, Grün, Grün, kariert, Hafer, Haselnuss, Haselnussbraun, Hellblau, Hellbraun, meliert, Helle, Feige, Helle, Haimbeere, Hellgelb/Natur, Hellgrau, meliert, Hellgrau, meliert/natur, Himbeere, Himbeerschaum, Holunder, Honig, Jadegrün, Jadegrün/natur, gestreift, Kakao, Karamell, Karamell, meliert, Kastanienbraun, Kobaltblau, Königsblau, Königsblau, mit, Streifen, Kortenrot, Kupfer, Kühles, Grün, Lavendel, Lavendelgrau, Lichtblau, Melange, Lila, Mahagoni-Rose, Mahagoni-Rose/natur, Marineblaues, Karomuster, Melierter, Flieder, Merlot, Mitternachtsblau, Mokka, Mondstein, Moos, Natur, Navy, Nelkenrosa, Nordic, Lila-Melange, Nordische, Marine, Nordischer, Boden, nordisches, Blau, Olivgrün, Orange, Orchidee, Pastellgrün, Perlweiß, Petrol, Pflaume, Pfingstrose, Piniengrün, Pink, Puder, Puderrosa, Rauchblau, Rauchblau/Sturmblau, Rosa, Rosenquarz, Rot, Rot, Melange, Rouge, Rubinrot, Sand, Schokobraun, Schwarz, Schwarz, meliert, Schwarz/Natur, Seenebel, Senf, Siberner, Salbei, Stahl, Strandroggen, Taupe, Tiefseeblau, Türkis, Ungefärbte, Baumwolle, Vintage, Ballerina, Vintage, Grau, Violette, Orchidee, Waldboden, Waldgrün, Walnuss, Walnuss/natur, Warmes, Grau, Weihnachtsrot, Weiß, Weiss/navy, Wüstengras, Zitronengras",
