...
setInterval(checkForPurchase, 15000); // Check every 15 seconds
    ...
    function sendMessageToIframe() {
      ...
      themeColor: "#000000",
      headerTitleG: "",
      headerSubtitleG: "Jeg er din digitale assistent og ved en hel del om sko, størrelser, brands og hvordan du handler hos Skoringen - både online og i butik. Spørg endelig løs, så prøver jeg at hjælpe dig så godt jeg kan. Men husk, jeg er kun en robot - så hvis noget er uklart eller ikke giver mening, kan du altid tage fat i vores kundeservice 💬",
      subtitleLinkText: "",
      subtitleLinkUrl: "",
        
      titleG: "Skobot - Din digitale AI assistent",
      firstMessage: "Hej! Jeg hedder Skobot 😊 Jeg er din digitale AI assistent og står klar til at hjælpe dig med spørgsmål om produkter, åbningstider og vores services. Tøv ikke med at skrive, hvis du har brug for hjælp! Når du skriver til mig, accepterer du samtidig, at vores samtale bliver behandlet og gemt. 🤖",
...
function trackChatbotOpen() {
  ...
  .catch(function(error) {
    ...
    function showPopup() {
      ...
      const popupText = "Jeg kan anbefale sko  og besvare sprøgsmål👟";
