function initChatbot() {
  ...
  trackingNeedsAuth: true,
      ...
      knowledgebaseIndexApiEndpoint: "dillingfi-faq",
      flow2KnowledgebaseIndex: "dillingfi-pro",
      flow3KnowledgebaseIndex: "dillingfi-pro",
      flow4KnowledgebaseIndex: "dillingfi-kat",
      apiFlowKnowledgebaseIndex: "dillingfi-faq",
      websiteOverride: "dilling.fi",
      languageOverride: "Finnish",
      valutaOverride: "EUR",
      customVar1: "+358 9 4245 4450",
      dillingProductsKatOverride: "Whenever there is a category link in the context, and if it matches the user's request, add it at the end as a hyperlink to the category. Do this often. They look like this: https://www.dilling.fi/kategoria/esimerkki – but never create your own links. You must find them in the content, and if there is none, add the matching broad category from here and always say that they can use the product filter to try to find their product:  - https://www.dilling.fi/kategoria/vauva - https://www.dilling.fi/kategoria/lapset - https://www.dilling.fi/kategoria/miehet - https://www.dilling.fi/kategoria/naiset - https://www.dilling.fi/kategoria/uutuudet (if no gender or age is provided)  The hyperlink name should match the URL end, e.g., kategoria/naiset hyperlink name should be kategoria naiset or /kategoria/lapset/mekot be lasten mekot. It's fine to send a broad link and always explain that they can try to use the product filter on the category page you sent.",
      dillingColors: "[   \"Aavikkoruoho\",   \"Arktinen sininen\",   \"Azurinsininen\",   \"Beige\",   \"Beige meleerattu\",   \"Beigemelange\",   \"Bordeaux\",   \"Granaattiomena\",   \"Harmaa\",   \"Harmaa vintage\",   \"Harmaamelange\",   \"Harmaanruskea\",   \"Harmaanvihreä\",   \"Harmaaraidallinen\",   \"Helmenvalkoinen\",   \"Himmeä musta\",   \"Hopeasalvia\",   \"Hunajanruskea\",   \"Jadenvihreä\",   \"Joulun sydän\",   \"Kaakao\",   \"Kastanjanruskea\",   \"Kaura\",   \"Kermanvärinen\",   \"Kuparinruskea\",   \"Kuninkaansininen\",   \"Kuninkaansininen raidallinen\",   \"Kuukivi\",   \"Laventeli\",   \"Laventelinharmaa\",   \"Luumunpunainen\",   \"Luonnonvärinen\",   \"Mansikanpunainen\",   \"Mariininsininen\",   \"Meleerattu liila\",   \"Meleerattu punainen\",   \"Meleerattu vaaleansininen\",   \"Meleerattu vaaleanruskea\",   \"Merlot\",   \"Metsänvihreä\",   \"Mokka\",   \"Munakoiso\",   \"Musta\",   \"Myrskynsininen\",   \"Navy\",   \"Nordic Navy\",   \"Norsunluu\",   \"Orkidean violetti\",   \"Pähkinänruskea\",   \"Petroolin sininen\",   \"Pionin pinkki\",   \"Pohjoinen maa\",   \"Pohjoisen sininen\",   \"Pohjoismainen meleerattu liila\",   \"Punaruskea\",   \"Puuteripinkki\",   \"Puuteriroosa\",   \"Päärynänvihreä\",   \"Rantavehnä\",   \"Roosa mahonki\",   \"Ruosteenpunainen\",   \"Ruskea\",   \"Ruskea ruutu\",   \"Ruskeamelange\",   \"Ruusunpunainen\",   \"Saksanpähkinä\",   \"Sammaleenvihreä\",   \"Seljanmarja\",   \"Siniharmaa\",   \"Siniharmaa melange\",   \"Sininen\",   \"Sitruunaruoho\",   \"Syvänmerensininen\",   \"Talvitaivas\",   \"Tumma kirsikka\",   \"Tumma koralli\",   \"Tumma laventeli\",   \"Tumma mariini\",   \"Tumma oliivi\",   \"Tumma roosa\",   \"Tumma sinivihreä\",   \"Tummanpunainen\",   \"Tummanvihreä melange\",   \"Tummansininen\",   \"Tummansininen ruutu\",   \"Vaaleanharmaa\",   \"Vaaleanpunainen neilikka\",   \"Vaaleanruskea\",   \"Vadelmanpunainen\",   \"Vadelmavaahto\",   \"Valkoinen\",   \"Viidakonvihreä\",   \"Vihertävä beige\",   \"Vihreä\",   \"Viininpunainen\",   \"Vintage ballerina\",   \"Värjäämätön puuvilla\" ]",      
      
      replaceExclamationWithPeriod: true,
      fontFamily: "Montserrat, sans-serif",
      
      // Set FreshdeskForm text
      freshdeskEmailLabel: "Sähköpostiosoitteesi:",
      freshdeskMessageLabel: "Viestisi asiakaspalvelulle:",
      freshdeskImageLabel: "Lataa kuva (valinnainen):",
      freshdeskChooseFileText: "Valitse tiedosto",
      freshdeskNoFileText: "Ei tiedostoa valittu",
      freshdeskSendingText: "Lähetetään...",
      freshdeskSubmitText: "Lähetä yhteydenotto",
        
      // Set FreshdeskForm validation error messages
      freshdeskEmailRequiredError: "Sähköposti on pakollinen",
      freshdeskEmailInvalidError: "Anna kelvollinen sähköpostiosoite",
      freshdeskFormErrorText: "Korjaa lomakkeen virheet",
      freshdeskMessageRequiredError: "Viesti on pakollinen",
      freshdeskSubmitErrorText: "Tapahtui virhe lähetettäessä yhteydenottoa. Yritä uudelleen.",
 ...
      freshdeskGroupId: 22000157432,
      ...
      themeColor: "#000000",
      headerTitleG: "Olen DILLINGin tekoälychatbotti",
      headerSubtitleG: "Keskustelet tekoälychatbotin kanssa. Hyväksyt samalla, että keskustelu voidaan tallentaa ja käsitellä kokemuksesi parantamiseksi. Lue lisää tietosuojakäytännöstämme. Huom: chatbot voi joissain tapauksissa antaa virheellistä tietoa.",
  ...
  function showPopup() {
    ...
    const popupText = "Tarvitsetko apua?";
