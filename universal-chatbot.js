"use strict";(()=>{var s={log:Q,error:et,warn:tt,isEnabled:S};function Q(...t){S()&&console.log(...t)}function tt(...t){S()&&console.warn(...t)}function et(...t){S()&&console.error(...t)}function S(){return!!(window.localStorage.getItem("CHATBOT_LOGGING_ENABLED")==="true"||window.CHATBOT_LOGGING_ENABLED)}var f={getUrl:ot};function ot({ctx:t}){var e;return t.isPreviewMode&&((e=window.CHATBOT_PREVIEW_CONFIG)!=null&&e.backendUrl)?window.CHATBOT_PREVIEW_CONFIG.backendUrl:"https://api.dialogintelligens.dk"}var u={getTargetOrigin:nt};function nt(t){if(!t)return"";if(t.startsWith("/"))return window.location.origin;try{return new URL(t).origin}catch(e){return t.replace(/\/$/,"")}}var l={isIframeEnlarged:!1,chatbotInitialized:!!window.chatbotInitialized,hasReportedPurchase:!1,splitTestId:null,_config:null,_chatbotId:null,_ctx:null,setChatbotInitialized(){window.chatbotInitialized=!0,this.chatbotInitialized=!0},toggleIsIframeEnlarged(){this.isIframeEnlarged=!this.isIframeEnlarged},setHasReportedPurchase(t){this.hasReportedPurchase=t},setSplitTestId(t){this.splitTestId=t},setConfig(t){this._config=t},getConfig(){return this._config},setChatbotId(t){this._chatbotId=t},getChatbotId(){return this._chatbotId},setCtx(t){this._ctx=t},getCtx(){return this._ctx},updateConfig(t){this._config&&(this._config={...this._config,...t})},getState(){return{isIframeEnlarged:this.isIframeEnlarged,chatbotInitialized:this.chatbotInitialized,hasReportedPurchase:this.hasReportedPurchase,splitTestId:this.splitTestId}},reset(){this.isIframeEnlarged=!1,this.chatbotInitialized=!1,this.hasReportedPurchase=!1,this.splitTestId=null,this._config=null,this._chatbotId=null,this._ctx=null,window.chatbotInitialized=!1}};async function C({ctx:t}){var o,i;let e=document.getElementById("chat-iframe");if(e)try{let n=t.getConfig(),r=t.getChatbotId();s.log("sendMessageToIframe - chatbotID:",r,"iframeUrl:",n.iframeUrl),s.log("sendMessageToIframe - full config:",JSON.stringify(n,null,2));let d={action:"integrationOptions",chatbotID:r,...n,splitTestId:l.splitTestId,pagePath:t.isPreviewMode&&((o=window.CHATBOT_PREVIEW_CONFIG)!=null&&o.parentPageUrl)?window.CHATBOT_PREVIEW_CONFIG.parentPageUrl:window.location.href,isTabletView:window.innerWidth>=768&&window.innerWidth<1e3,isPhoneView:window.innerWidth<768,gptInterface:!1},c=n.iframeUrl,m=u.getTargetOrigin(c);m?(i=e.contentWindow)==null||i.postMessage(d,m):s.warn("No iframeUrl configured, cannot send message to iframe")}catch(n){s.warn("Failed to send message to iframe:",n)}}function T(t){return typeof CSS!="undefined"&&CSS.supports("height","1dvh")?`${t}dvh`:`${t}vh`}function b({ctx:t}){let e=t.getConfig(),o=document.getElementById("chat-iframe");if(!o)return;if(window.CHATBOT_PREVIEW_MODE===!0){e&&e.previewMode==="mobile"?(o.style.width="100vw",o.style.height=T(100),o.style.position="fixed",o.style.left="0",o.style.top="0",o.style.transform="none",o.style.bottom="0",o.style.right="0"):(o.style.width="calc(375px + 6vw)",o.style.height="calc(450px + 20vh)",o.style.position="fixed",o.style.left="auto",o.style.top="auto",o.style.transform="none",o.style.bottom="3vh",o.style.right="2vw");return}l.isIframeEnlarged?(o.style.width=e.iframeWidthEnlarged||"calc(2 * 45vh + 6vw)",o.style.height=T(90)):window.innerWidth<1e3?(o.style.width="100vw",o.style.height=T(100)):(o.style.width=e.iframeWidthDesktop||"calc(50vh + 8vw)",o.style.height=T(90)),o.style.position="fixed",window.innerWidth<1e3?(o.style.left="0",o.style.top="0",o.style.transform="none",o.style.bottom="0",o.style.right="0"):(o.style.left="auto",o.style.top="auto",o.style.transform="none",o.style.bottom="3vh",o.style.right="2vw"),C({ctx:t})}function y({ctx:t}){var c;let e=document.getElementById("chat-button"),o=document.getElementById("chat-iframe"),i=document.getElementById("chatbase-message-bubbles"),n=document.getElementById("minimize-button"),r=document.getElementById("chat-container");if(!o){s.error("Chat iframe not found");return}let d=o.style.display;if(s.log(`toggleChatWindow called. Current display: "${d}"`),d==="none"||!d){s.log("Opening chat..."),o.style.display="block",e&&(e.style.display="none"),i&&(i.style.display="none"),n&&(n.style.display="block"),r&&(r.classList.add("chat-open"),r.classList.remove("minimized"));let m=`chatMinimized_${t.getChatbotId()}`;localStorage.removeItem(m);let a=`popupState_${t.getChatbotId()}`;localStorage.setItem(a,"dismissed"),window.innerWidth>=1e3&&localStorage.setItem("chatWindowState","open"),b({ctx:t}),s.log("After adjustIframeSize - iframe display:",o.style.display,"dimensions:",o.style.width,"x",o.style.height),C({ctx:t}),setTimeout(()=>{window.dispatchEvent(new Event("resize"))},50),setTimeout(()=>{window.dispatchEvent(new Event("resize"))},150),setTimeout(()=>{window.dispatchEvent(new Event("resize"))},300);try{let p=t.getConfig().iframeUrl,h=u.getTargetOrigin(p);h&&((c=o.contentWindow)==null||c.postMessage({action:"chatOpened"},h))}catch(p){}}else s.log("Closing chat..."),o.style.display="none",e&&(e.style.display="block"),n&&(n.style.display="none"),r&&r.classList.remove("chat-open"),localStorage.removeItem("chatWindowState")}function R(){return{hide(){let t=document.getElementById("chat-container"),e=document.getElementById("chat-iframe");t&&(t.style.display="none"),e&&(e.style.display="none")},show(){let t=document.getElementById("chat-container"),e=document.getElementById("chat-button"),o=document.getElementById("chat-iframe");t&&(t.style.display="",t.classList.remove("chat-open")),e&&(e.style.display="block"),o&&(o.style.display="none")},open(){let t=l.getCtx();if(!t)return;let e=document.getElementById("chat-container");e&&(e.style.display="",e.classList.remove("chat-open"));let o=document.getElementById("chat-iframe");(!o||o.style.display==="none"||!o.style.display)&&y({ctx:t})},destroy(){let t=document.getElementById("chat-container");t&&t.remove();let e=document.getElementById("chat-iframe");e&&e.remove();let o=document.getElementById("di-chatbot-styles");o&&o.remove(),l.reset()}}}function E(t,e){let o=e?new CustomEvent(t,{detail:e}):new CustomEvent(t);window.dispatchEvent(o)}var w={open(){E("chat_open",{chat_type:"shopping_assistant"})},recommendation(){E("chat_recommendation",{chat_type:"shopping_assistant"})},response(t){E("chat_response",{chat_type:"shopping_assistant",response_latency_ms:t})},productClick(){E("chat_product_click",{chat_type:"shopping_assistant"})}};function $(){let t=null;return{start(){t=performance.now()},stop(){if(t===null)return null;let e=Math.round(performance.now()-t);return t=null,e}}}function I({ctx:t}){t.getConfig().purchaseTrackingEnabled&&t.hasSentMessageToChatbot()&&(setInterval(()=>it({ctx:t}),2e3),setInterval(()=>at({ctx:t}),2e3))}function it({ctx:t}){var o,i;let e=st({ctx:t});if(!(!e||!e.length))for(let n of e){let r=O(n);if(r){let d=ct((i=(o=r.textContent)==null?void 0:o.trim())!=null?i:"",t);if(d){localStorage.setItem(U(t.getChatbotId()),String(d));break}}}}function at({ctx:t}){if(!t.hasSentMessageToChatbot()||l.hasReportedPurchase)return;let e=rt({ctx:t});if(!e||!e.length)return;let o=e.map(i=>O(i)).filter(i=>!!i);o.length&&o.forEach(i=>{i.hasAttribute("data-purchase-tracked")||(i.setAttribute("data-purchase-tracked","true"),i.addEventListener("click",async()=>{let n=localStorage.getItem(U(t.getChatbotId()));n&&await lt(parseFloat(n),t)}))})}function O(t){let e=t?t.trim():"";try{return document.querySelector(e)}catch(o){return null}}function rt({ctx:t}){let{checkoutPurchaseSelector:e}=t.getConfig();return t.isPreviewMode&&e?["#purchase-tracking-checkout-purchase","#purchase-tracking-checkout-purchase-alternative"]:typeof e=="string"?e.split(",").map(o=>o.trim()).filter(Boolean):[]}function st({ctx:t}){let{checkoutPriceSelector:e}=t.getConfig();return t.isPreviewMode&&e?["#purchase-tracking-checkout-price"]:typeof e=="string"?e.split(",").map(o=>o.trim()).filter(Boolean):[]}async function lt(t,e){if(localStorage.getItem(_(e.getChatbotId()))){l.setHasReportedPurchase(!0);return}let o=e.getConfig().currency||"DKK",i=document.getElementById("chat-iframe");if(i&&i.contentWindow){let n=e.getConfig().iframeUrl,r=u.getTargetOrigin(n);i.contentWindow.postMessage({action:"reportPurchase",chatbotID:e.getChatbotId(),totalPrice:t,currency:o},r)}}function ct(t,e){let o=e.getConfig().priceExtractionLocale||"comma",i=t.match(/\d[\d.,]*/g);if(!i||i.length===0)return null;let n=0;for(let r of i){let d=r.replace(/[^\d.,]/g,"");o==="comma"?d=d.replace(/\./g,"").replace(",","."):d=d.replace(/,/g,"");let c=parseFloat(d);!isNaN(c)&&c>n&&(n=c)}return n>0?n:null}function _(t){let e=new Date,o=e.getFullYear(),i=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`purchaseReported_${`${o}-${i}-${n}`}_${t}`}function U(t){return`purchaseTotalPriceKey_${t}`}function x({ctx:t}){let e=`visitorKey_${t.getChatbotId()}`,o=localStorage.getItem(e);if(!o){let i=`visitor-${Date.now()}-${Math.floor(Math.random()*1e4)}`;return localStorage.setItem(e,i),i}return o}async function v({ctx:t}){try{let e=x({ctx:t}),o=f.getUrl({ctx:t}),i=await fetch(`${o}/api/split-assign?chatbot_id=${encodeURIComponent(t.getChatbotId())}&visitor_key=${encodeURIComponent(e)}`);if(!i.ok)return null;let n=await i.json();return n&&n.enabled?n:null}catch(e){return s.warn("Split test assignment failed:",e),null}}async function F({variantId:t,ctx:e}){try{let o=x({ctx:e}),i=f.getUrl({ctx:e});await fetch(`${i}/api/split-impression`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chatbot_id:e.getChatbotId(),variant_id:t,visitor_key:o})})}catch(o){s.warn("Failed to log split impression:",o)}}async function k({ctx:t}){let e=document.getElementById("chat-iframe");if(e&&e.style.display!=="none")return;let o=`chatMinimized_${t.getChatbotId()}`;if(localStorage.getItem(o)==="true")return;let i=window.innerWidth<1e3,n=`popupState_${t.getChatbotId()}`,r=`pageVisitCount_${t.getChatbotId()}`,d=`lastPageTime_${t.getChatbotId()}`,c=localStorage.getItem(n);if(!i){if(c==="shown"){dt({ctx:t});return}if(c==="dismissed")return;await H({ctx:t}),localStorage.setItem(n,"shown");return}if(i){if(t.getConfig().popupShowOnMobile===!1||c==="dismissed")return;let m=`popupShowCount_${t.getChatbotId()}`,a=parseInt(localStorage.getItem(m)||"0"),g=t.getConfig().popupMaxDisplays||2;if(a>=g){localStorage.setItem(n,"dismissed");return}let p=parseInt(localStorage.getItem(r)||"0");p++,localStorage.setItem(r,p.toString());let h=Date.now();localStorage.setItem(d,h.toString()),p>=2&&setTimeout(async()=>{let L=localStorage.getItem(d),q=localStorage.getItem(n),J=localStorage.getItem(`chatMinimized_${t.getChatbotId()}`);L===h.toString()&&q!=="dismissed"&&J!=="true"&&(a++,localStorage.setItem(m,a.toString()),await H({ctx:t}),setTimeout(()=>{let P=document.getElementById("chatbase-message-bubbles");if(P&&P.style.display==="flex"){P.style.display="none";let X=t.getConfig().popupMaxDisplays||2;a>=X&&localStorage.setItem(n,"dismissed")}},15e3))},6e3)}}async function H({ctx:t}){var a,g;let e=document.getElementById("chatbase-message-bubbles"),o=document.getElementById("popup-message-box");if(!e||!o)return;let i=await W({ctx:t})||"Har du brug for hj\xE6lp?",n=null;try{n=await v({ctx:t}),n&&n.variant&&n.variant.config&&n.variant.config.popup_text&&(i=n.variant.config.popup_text)}catch(p){s.warn("Split test check failed:",p)}o.innerHTML=`${i} <span id="funny-smiley">\u{1F60A}</span>`,n&&n.variant_id&&F(n.variant_id);let r=(g=(a=o.textContent)==null?void 0:a.trim().length)!=null?g:0,d=Math.max(380,Math.min(700,r*3.2+260));e.style.width=d+"px";let c=window.innerWidth<1e3,m=(t.getConfig().buttonBottom||"20px").replace(/\s*!important/g,"");r<=20?c?e.style.bottom=`calc(${m} + -11px)`:e.style.bottom=`calc(${m} + 14px)`:c?e.style.bottom=`calc(${m} + -20px)`:e.style.bottom=`calc(${m} + 5px)`,e.classList.add("animate"),e.style.display="flex",setTimeout(()=>{let p=document.getElementById("funny-smiley");p&&e.style.display==="flex"&&(p.classList.add("blink"),setTimeout(()=>p.classList.remove("blink"),1e3))},2e3),setTimeout(()=>{let p=document.getElementById("funny-smiley");p&&e.style.display==="flex"&&(p.classList.add("jump"),setTimeout(()=>p.classList.remove("jump"),1e3))},12e3)}async function dt({ctx:t}){var a,g;let e=document.getElementById("chatbase-message-bubbles"),o=document.getElementById("popup-message-box");if(!e||!o)return;let i=await W({ctx:t})||"Har du brug for hj\xE6lp?",n=null;try{n=await v({ctx:t}),n&&n.variant&&n.variant.config&&n.variant.config.popup_text&&(i=n.variant.config.popup_text)}catch(p){s.warn("Split test check failed:",p)}o.innerHTML=`${i} <span id="funny-smiley">\u{1F60A}</span>`;let r=(g=(a=o.textContent)==null?void 0:a.trim().length)!=null?g:0,d=Math.max(380,Math.min(700,r*3.2+260));e.style.width=d+"px";let c=window.innerWidth<1e3,m=(t.getConfig().buttonBottom||"20px").replace(/\s*!important/g,"");r<=20?c?e.style.bottom=`calc(${m} + -11px)`:e.style.bottom=`calc(${m} + 14px)`:c?e.style.bottom=`calc(${m} + -20px)`:e.style.bottom=`calc(${m} + 5px)`,e.style.display="flex"}async function W({ctx:t}){try{let e=x({ctx:t}),o=f.getUrl({ctx:t}),i=window.location.href,n=await fetch(`${o}/api/popup-message?chatbot_id=${encodeURIComponent(t.getChatbotId())}&visitor_key=${encodeURIComponent(e)}&url=${encodeURIComponent(i)}`);if(!n.ok)return null;let r=await n.json();return r&&r.popup_text?String(r.popup_text):null}catch(e){return s.warn("Popup fetch failed:",e),null}}var D={register:G},A=$();function G({ctx:t}){let e=document.getElementById("chat-button"),o=document.getElementById("chat-iframe"),i=document.getElementById("chatbase-message-bubbles"),n=document.querySelector(".close-popup"),r=document.getElementById("minimize-button");if(!e||!o){s.error("Chatbot elements not found. Retrying in 100ms..."),setTimeout(()=>G({ctx:t}),100);return}e&&o&&e.addEventListener("click",()=>{window.getComputedStyle(o).display!=="none"||w.open(),y({ctx:t})}),i&&o&&i.addEventListener("click",a=>{if(a.target.closest(".close-popup"))return;window.getComputedStyle(o).display!=="none"||w.open(),y({ctx:t})}),n&&n.addEventListener("click",a=>{if(a.stopPropagation(),i&&(i.style.display="none"),window.innerWidth<1e3){let p=`popupState_${t.getChatbotId()}`;localStorage.setItem(p,"dismissed")}}),r&&r.addEventListener("click",a=>{a.stopPropagation(),s.log("Minimize button clicked");let g=document.getElementById("chat-container"),p=document.getElementById("chatbase-message-bubbles");o.style.display="none",e.style.display="block",r.style.display="none",g&&(g.classList.remove("chat-open"),g.classList.add("minimized")),p&&(p.style.display="none");let h=`chatMinimized_${t.getChatbotId()}`;localStorage.setItem(h,"true")});let d=document.getElementById("plus-overlay");d&&d.addEventListener("click",a=>{a.stopPropagation();let g=document.getElementById("chat-container");g&&g.classList.remove("minimized"),r&&(r.style.display="");let p=`chatMinimized_${t.getChatbotId()}`;localStorage.removeItem(p);let h=`popupState_${t.getChatbotId()}`;localStorage.getItem(h)!=="dismissed"&&setTimeout(()=>k({ctx:t}),500)});let c=`chatMinimized_${t.getChatbotId()}`;if(localStorage.getItem(c)==="true"){let a=document.getElementById("chat-container");a&&a.classList.add("minimized")}window.addEventListener("message",a=>{let g=t.getConfig().iframeUrl,p=u.getTargetOrigin(g);if(a.origin===p)if(a.data.action==="purchaseReported"&&(l.setHasReportedPurchase(!0),localStorage.setItem(_(t.getChatbotId()),"true")),a.data.action==="toggleSize")l.toggleIsIframeEnlarged(),b({ctx:t});else if(a.data.action==="closeChat"){s.log("Received closeChat message from iframe");let h=document.getElementById("chat-container");o.style.display="none",e.style.display="block",r&&(r.style.display="none"),h&&h.classList.remove("chat-open"),localStorage.removeItem("chatWindowState")}else if(a.data.action==="navigate"&&a.data.url)window.location.href=a.data.url;else if(a.data.action==="productClick")w.productClick();else if(a.data.action==="firstMessageSent")localStorage.setItem(`hasSentMessage_${t.getChatbotId()}`,"true"),I({ctx:t});else if(a.data.action==="userMessageSubmitted")A.start();else if(a.data.action==="assistantFirstToken"){let h=A.stop();h!==null&&w.response(h)}else a.data.action==="productRecommendation"&&w.recommendation()}),window.addEventListener("resize",()=>b({ctx:t})),b({ctx:t});function m(){window.dispatchEvent(new Event("resize"))}setTimeout(m,100),setTimeout(m,300),setTimeout(m,500),setTimeout(m,800),setTimeout(m,1200),o.onload=()=>{C({ctx:t})},setTimeout(()=>{o&&o.style.display==="none"&&C({ctx:t})},2e3)}var V={generate:mt};function mt({ctx:t}){let e=t.getConfig(),o=e.iframeUrl||"https://chatbot.dialogintelligens.dk";return s.log("generateChatbotHTML - iframeUrl:",o,"chatbotID:",t.getChatbotId()),`
    ...
    `}var j={inject:pt};function pt({ctx:t}){let e=t.getConfig(),o=e.productButtonColor||e.themeColor||"#1a1d56",i=`
        /* ----------------------------------------
            A) ANIMATIONS
            ---------------------------------------- */
        @keyframes blink-eye {
    ...
    `,n=document.createElement("style");n.id="di-chatbot-styles",n.appendChild(document.createTextNode(i)),document.head.appendChild(n)}var N={get:gt};async function gt({ctx:t}){var r,d;let o=(typeof __CHATBOT_URL__!="undefined"?__CHATBOT_URL__:void 0)||(t.isPreviewMode&&((r=window.CHATBOT_PREVIEW_CONFIG)!=null&&r.iframeUrl)?window.CHATBOT_PREVIEW_CONFIG.iframeUrl:"https://chatbot.dialogintelligens.dk");if(s.log("Config.get - defaultIframeUrl:",o),t.isPreviewMode){let c=t.getConfig(),m={...c,iframeUrl:c.iframeUrl||o};if(!((d=window.CHATBOT_PREVIEW_CONFIG)!=null&&d.leadFields))try{let a=await fetch(`${f.getUrl({ctx:t})}/api/integration-config/${t.getChatbotId()}`);if(a.ok){let g=await a.json();m={...c,...g,iframeUrl:c.iframeUrl||g.iframeUrl||o}}}catch(a){s.warn("Failed to fetch leadFields for preview mode:",a)}return l.setConfig(m),l.setChatbotId(t.getChatbotId()),{isPreviewMode:t.isPreviewMode,getChatbotId:t.getChatbotId,hasSentMessageToChatbot:t.hasSentMessageToChatbot,getConfig:()=>{var a;return(a=l.getConfig())!=null?a:m}}}let i=await ht({ctx:t}),n={...i,iframeUrl:i.iframeUrl||o};return l.setConfig(n),l.setChatbotId(t.getChatbotId()),{isPreviewMode:t.isPreviewMode,getChatbotId:t.getChatbotId,hasSentMessageToChatbot:t.hasSentMessageToChatbot,getConfig:()=>{var c;return(c=l.getConfig())!=null?c:n}}}async function ht({ctx:t}){try{s.log(`Loading configuration for chatbot: ${t.getChatbotId()}`);let e=await fetch(`${f.getUrl({ctx:t})}/api/integration-config/${t.getChatbotId()}`);if(e.status===403)return s.warn("Domain not authorized for this chatbot. Widget will not load."),{...t.getConfig(),_domainBlocked:!0};if(!e.ok)throw new Error(`Failed to load configuration: ${e.status} ${e.statusText}`);let o=await e.json();return{...t.getConfig(),...o}}catch(e){return s.error("Error loading chatbot config:",e),{...t.getConfig(),themeColor:"#1a1d56",borderRadiusMultiplier:1,headerTitleG:"",headerSubtitleG:"Vores virtuelle assistent er h\xE4r for at hj\xE6lpe dig.",titleG:"Chat Assistent",enableMinimizeButton:!0,enablePopupMessage:!0}}}function B(){let t=document.getElementById("chat-button");t&&t.addEventListener("click",()=>{let e=document.getElementById("notification-badge");e&&e.remove(),s.log("Chatbot opened \u2014 notification badge removed.")})}function K({ctx:t}){window.addEventListener("previewConfigUpdate",e=>{let o=e,i=l.getChatbotId(),n=o.detail.chatbotID,r=n&&n!==i;n&&l.setChatbotId(n),l.updateConfig(o.detail),o.detail.chatButtonImageUrl!==void 0&&ut({chatButtonImageUrl:o.detail.chatButtonImageUrl}),b({ctx:t}),I({ctx:t}),r?(s.log("Preview: Switching chatbot from",i,"to",n),C({ctx:t}),setTimeout(()=>{ft({ctx:t})},100)):C({ctx:t})})}function ft({ctx:t}){var o;let e=document.getElementById("chat-iframe");if(e)try{let i=t.getConfig(),n=i.iframeUrl,r=u.getTargetOrigin(n);r&&(s.log("Sending resetConversation to iframe with firstMessage:",i.firstMessage),(o=e.contentWindow)==null||o.postMessage({action:"resetConversation",firstMessage:i.firstMessage},r))}catch(i){s.warn("Failed to send reset to iframe:",i)}}function ut({chatButtonImageUrl:t}){let e=document.getElementById("chat-button");if(!e)return;let o=t?`<img src="${t}" alt="Chat" />`:`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 651">
            <path d="M0 0 C1.18013672 0.19335938 2.36027344 0.38671875 3.57617188 0.5859375 C59.5538758 10.10655486 113.52671101 33.42516318 157.42724609 69.70361328 C158.96654476 70.97242358 160.52414335 72.21892833 162.08203125 73.46484375 C170.48246311 80.31135664 178.13814279 87.92667924 185.8125 95.5625 C186.61646713 96.35856659 186.61646713 96.35856659 187.43667603 97.17071533 C194.4282304 104.10912388 200.90456545 111.24413176 207 119 C207.85759874 120.06027954 208.71557379 121.12025504 209.57421875 122.1796875 C243.74294324 165.75902188 265.49246848 216.56825559 275 271 C275.18079102 272.03382813 275.36158203 273.06765625 275.54785156 274.1328125 C280.79965418 306.12391236 280.53979773 342.07591201 275 374 C274.80664062 375.13598633 274.61328125 376.27197266 274.4140625 377.44238281 C263.53963247 439.24874978 235.2590019 496.61201036 192.3828125 542.42578125 C190.32466446 544.64925594 188.36675656 546.91531996 186.4375 549.25 C185.633125 550.1575 184.82875 551.065 184 552 C183.34 552 182.68 552 182 552 C182 552.66 182 553.32 182 554 C180.671875 555.33984375 180.671875 555.33984375 178.75 556.9375 C175.24889003 559.90091769 171.89656086 562.97488733 168.5625 566.125 C102.31951852 627.5707075 12.3232672 650.95326951 -76 648 C-85.41882655 647.59353945 -94.70187709 646.53577614 -104 645 