...
onDOMReady(function() {
  ...
  var css = "/* Container for chat button and speech balloon */" +
    ...
    "width: 220px; height: 95px; background-size: cover; background-repeat: no-repeat;" +
    "background-position: center; z-index: 150;" +
    "}" +
    "/* Close button styles */" +
    "#close-balloon {" +
  ...
  // Inject HTML into the body WITHOUT the iframe's src attribute
  var chatbotHTML = '<div id="chat-container">' +
    ...
    '</div>' +
    '</div>' +
    '<iframe id="chat-iframe" style="display: none; position: fixed; bottom: 3vh; right: 2vw;' +
...
// Your existing speech balloon functions (commented out or active as per your preference)
/*
var gifUrls = [
