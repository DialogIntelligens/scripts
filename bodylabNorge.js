...
function incrementPageCount() {
  ...
  count++;
  setCookie("pageCount", count.toString(), 30, ".bodylab.no");
}
...
onDOMReady(function() {
  ...
  function sendMessageToIframe() {
    var messageData = {
      ...
      apiFlowAPI: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/2d263cc3-7334-44db-b763-29592d22d140",
  ...
  function showPopup() {
    ...
    if (!userHasVisited) {
      setCookie("userHasVisited", "true", 1, ".bodylab.no");
    ...
    popupCount++;
    setCookie("popupCount", popupCount.toString(), 1, ".bodylab.no");
    var currentTime = new Date().getTime();
    setCookie("popupLastShown", currentTime.toString(), 1, ".bodylab.no");
