document.addEventListener('DOMContentLoaded', function() {
  ...
  function initChatbot() {
    ...
    function sendMessageToIframe() {
      ...
      statestikAPI: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/1c76d145-08da-4589-89f6-26d7686a7069",
      apiEndpoint: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/7a4d06b3-30ba-417d-a093-f730014f498a",
      fordelingsflowAPI: "",
      flow2Key: "",
      flow2API: "",
      flow3Key: "product",
    ...
    function showPopup() {
      ...
      const popupText = "Hei og velkommen til Stiftelsen Crux. Jeg håper du har en god dag – hva kan jeg hjelpe deg med?";
