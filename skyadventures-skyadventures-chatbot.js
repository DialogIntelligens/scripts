document.addEventListener('DOMContentLoaded', function() {
  ...
  if (urlFlag === 'open') {
    ...
    function sendMessageToIframe() {
      ...
      chatbotID: "skyadventures",
      pagePath: window.location.href,
      statestikAPI: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/1564ee13-e4db-4b7f-8fb6-138e952bb6fa",
      apiEndpoint: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/866fffa1-4572-478b-a8cf-b59c9679dbcc",
      fordelingsflowAPI: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/cdbddbdd-3eb5-45b6-8437-a679e5437165",
      flow2Key: "",
      flow2API: "",
      flow3Key: "product",
      flow3API: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/46466cd7-2dd7-4108-99e4-62d9cf2fe565",
      flow4API: "",
      flow4Key: "",
  ...
  // If the iframe is already visible, post the message immediately.
    ...
    function showPopup() {
      ...
      const popupText = "Hej, jag är Vinge – din AI-assistent 😊 Fråga mig om allt – från kurser till produkter 🪂";
