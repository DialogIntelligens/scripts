...
setInterval(checkForPurchase, 15000); // Check every 15 seconds
    ...
    function sendMessageToIframe() {
      ...
      knowledgebaseIndexApiEndpoint: "gardinexperten",
      ...
      headerLogoG: "https://raw.githubusercontent.com/DialogIntelligens/image-hosting/master/chatbot_logo/logo-1752155971701.png",
      messageIcon: "https://raw.githubusercontent.com/DialogIntelligens/image-hosting/master/chatbot_message_icon/logo-1752576111148.png",
      themeColor: "#374c51",
...
function trackChatbotOpen() {
  ...
  .catch(function(error) {
    ...
    function showPopup() {
      ...
      const popupText = "Hej, jeg kan besvare de fleste af dine spørgsmål 🤖";
