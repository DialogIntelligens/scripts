function initChatbot() {
  ...
  function sendMessageToIframe() {
    ...
    var messageData = {
      ...
      dillingColors: "Aardbeienmilkshake, Aardbeienrood, Abrikoos, Aqua, blauw, Aubergine, Azuurblauw, Beige, Beige, melange, Beige/marineblauw, Beigemelange, Blauw, Blauw, melange, Blauw, met, bruinmelange, stippen, Blauwgraniet, melange, Blauwmelange, Bordeaux, Bordeauxrood, Bosgroen, Bosnacht, Bruin, Bruine, ruiten, Bruinmelange, Bubblegum, Cacao, Cappucino/beige, Chocoladebruin, Citroengras, Cortenstaal, Croissant, Dennengroen, Diep, groenblauw, Diep, roze, Diepzeeblauw, Donker, cherry, Donker, groenmelange, Donker, marineblauw, Donkerbruin, Donkerkoraal, Donkerblauw, Donkere, nootmuskaat, Donkergrijsmelange, Donkergroen, Donkernavy, Donkerrood, Eggnog, Framboos, Framboos, crème, Frappé, Grape, Granaatappel, Granaatappel/aardbeienmilkshake, Granaatappel/nordic, blauw/natuur, Grijs, Grijs, gestreept, Grijs, gemêleerd, met, strepen, Grijsblauw, Grijsblauw, en, stormblauw, Grijsgroen, Grijsmelange, Groen, Groen, geruit, Groenblauw, Havermout, Hazelnoot, Helderblauw, Honing, IJsblauw, IJzig, groen, Ivoor, Jadegroen, Jadegroen/natuur, Junglegroen, Karamel, Karamelmelange, Kastanjebruin, Kersthart, Kerstrood, Kobaltblauw, Koningsblauw, Koningsblauw, met, strepen, Koperbruin, Lavendel, Lavendel, en, grijslila, Lavendelgrijs, Licht, bruin, melange, Licht, orchidee, Licht, vijg, Lichtblauw, Lichtblauw, melange, Lichtgeel/natuur, Lichtgrijs, Lichtgrijs/natuur, Lichtgrijsmelange, Lila, Limonade, Maansteen, Mahonie, roze, Mahonie, roze/, natuur, Marineblauw, Marineruiten, Merlot, Middernacht, blauw, Mistig, roze, Mokka, Mos, Mosterd, Natuur, Navy, Nordic, Navy, Nordic, aarde, Nordic, blauw, Nordic, blauw/natuur, Olijfgroen, Ongeverfd, katoen, Oranje, Orchidee, Mauve, Oudroze, Parelmoer, wit, Peergroen, Peergroen/, natuur, Petrolblauw, Pink, Pink, blush, Pioenrozen, roze, Poeder, Poederbeige, Poederroze, Poolblauw, Poolblauw/, natuur, Pruimpaars, Rood, Rood, melange, Rouge, Roze, Roze, Anjer, Rozenkwarts, Scandinavisch, lilamelange, Sering, melange, Staal, Stoffig, zwart, Stormblauw, Taupe, Turquoise, Vijg, Vintage, Grijs, Vintage, ballerina, Vlierbes, Walnoot, Walnoot/, natuur, Warm, grijs, Wit, Wit/navy, Witgroen, Woestijngras, Zand, Zandhaver, blauw, Zeemist, Zilversalie, Zilverblauw, Zwart, Zwart/beige, Zwartmelange",
  ...
  function showPopup() {
    ...
    if (!userHasVisited) {
      ...
      messageBox.innerHTML = `Heb je hulp nodig? <span id="funny-smiley">😊</span>` ;
    } else {
      messageBox.innerHTML = `Heb je hulp nodig? <span id="funny-smiley">😄</span>`;
    }
