document.addEventListener('DOMContentLoaded', function() {
  ...
  if (urlFlag === 'open') {
    ...
    function sendMessageToIframe() {
      ...
      privacyLink: "https://raw.githubusercontent.com/DialogIntelligens/image-hosting/master/Privacy_policy_DKTrimmer.pdf",
    ...
    function showPopup() {
      ...
      const popupText = "Har du brug for hjælp? Jeg kan se hvilken model der passer og svare på spøgsmål";
