...
function initChatbot() {
  ...
  var css = `
    ...
    .notification-badge-text {
      ...
      /* Minimize button styles (mobile only) */
      #minimize-button {
        display: none;
        position: absolute;
        top: -8px;
      ...
      /* Show minimize button only on mobile when chat is closed and not minimized */
      @media (max-width: 800px) {
        #chat-container:not(.chat-open):not(.minimized) #minimize-button {
      ...
      /* Hide minimize features on desktop */
