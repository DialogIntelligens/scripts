...
setInterval(checkForPurchase, 15000); // Check every 15 seconds
    ...
    function sendMessageToIframe() {
      ...
      knowledgebaseIndexApiEndpoint: "aida",
      ...
      headerLogoG: "https://raw.githubusercontent.com/DialogIntelligens/image-hosting/master/chatbot_logo/logo-1752070778306.png",
      messageIcon: "https://raw.githubusercontent.com/DialogIntelligens/image-hosting/master/chatbot_message_icon/logo-1752152138389.png",
      themeColor: "#c9c4bd",
      headerTitleG: "",
      ...
      titleG: "AIDA AI",
      firstMessage: "Hej 😊 Spørg mig om alt – lige fra produkter til generelle spørgsmål, eller få personlige anbefalinger 🤖 \nDu er også altid velkommen til at kontakte vores menneskelige kunderservice, hvor vi bestræber os efter at svare indenfor 24 timer.",
...
function trackChatbotOpen() {
  ...
  .catch(function(error) {
    ...
    function showPopup() {
      ...
      const popupText = "Jeg kan svare på spørgsmål og give anbefalinger";
