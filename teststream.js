...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function sendMessageToIframe() {
    ...
    var messageData = {
      ...
      SOCKET_SERVER_URL: "https://den-traelseste-backup.onrender.com/",
      apiEndpoint: "https://den-traelseste-backup.onrender.com/api/v1/prediction/bfd6a037-e866-44ec-a14f-92b21d73862b",
      fordelingsflowAPI: "",
      flow2Key: "",
      flow2API: "",
      flow3Key: "",
