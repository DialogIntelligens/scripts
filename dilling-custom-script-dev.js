...
(function () {
  ...
  var SCRIPT_NAME = "dilling-custom-script-dev.js";
  var INIT_FLAG = "__DI_DILLING_CUSTOM_SCRIPT_DEV_INIT__";
  ...
  var notificationSvg =
    '<svg class="di-dilling-custom-launcher__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 59.333 59.333" aria-hidden="true" focusable="false">' +
    '<rect fill="var(--di-dilling-custom-launcher-bg,#262524)" width="59.333" height="59.333" rx="5.669" ry="5.669"/>' +
    "<g>" +
    '<path fill="var(--di-dilling-custom-launcher-fg,#fff)" d="M42.352,19.023h-15.463c-.548,0-.992.444-.992.992s.444.992.992.992h15.463c.433,0,.785.353.785.785v21.026l-4.264-4.293c-.187-.188-.439-.293-.704-.293h-18.716c-.433,0-.784-.353-.784-.785v-8.176c0-.548-.444-.992-.992-.992s-.992.444-.992.992v8.176c0,1.527,1.242,2.77,2.769,2.77h18.303l5.669,5.707c.19.191.445.293.704.293.128,0,.256-.024.378-.075.372-.153.614-.515.614-.917v-23.433c0-1.527-1.242-2.77-2.77-2.77Z"/>' +
    '<path fill="var(--di-dilling-custom-launcher-fg,#fff)" d="M16.986,24.534c0,.392.317.709.709.709s.709-.317.709-.709c0-.023,0-.048,0-.071.034-2.171,1.614-3.739,3.783-3.739.392,0,.709-.321.709-.713s-.317-.709-.709-.709c-1.038,0-1.99-.37-2.682-1.044-.721-.702-1.102-1.658-1.101-2.767h0c0-.392-.317-.709-.709-.709s-.709.317-.709.709c0,.023,0,.048,0,.071-.034,2.171-1.614,3.739-3.782,3.739-.392,0-.709.317-.709.709v.004c0,.392.317.709.709.709,1.038,0,1.99.371,2.681,1.044.721.702,1.102,1.659,1.101,2.767h0ZM15.895,20.014c.354-.206.684-.454.979-.741.324-.315.6-.673.824-1.062.436.748,1.051,1.364,1.796,1.8-.354.205-.683.453-.979.741-.323.315-.6.672-.824,1.061-.435-.747-1.051-1.364-1.796-1.799Z"/>' +
    '<path fill="var(--di-dilling-custom-launcher-fg,#fff)" d="M21.034,15.746h.789v.788c0,.234.19.425.425.425s.425-.19.425-.425v-.788h.788c.234,0,.425-.19.425-.425s-.19-.425-.425-.425h-.788v-.788c0-.234-.19-.425-.425-.425s-.425.19-.425.425v.788h-.789c-.234,0-.425.19-.425.425s.19.425.425.425Z"/>' +
    "</g>" +
    '<rect fill="var(--di-dilling-custom-launcher-fg,#fff)" x="37.49" y="14.947" width="12.928" height="12.928" rx="2.835" ry="2.835"/>' +
    '<path fill="var(--di-dilling-custom-launcher-bg,#262524)" d="M43.41,19.148c-.509.569-1.5,1.004-2.332,1.066v-1.45c1.19-.174,2.256-.992,2.604-1.649h1.338v8.677h-1.611v-6.644Z"/>' +
    "</svg>";
  ...
  // DEV ONLY: when the production dilling-custom-script.js is already on the page,
  // drop its launcher and styles so this copy renders instead.
  function removeLiveLauncher() {
    var liveRoot = document.getElementById(ROOT_ID);
    if (liveRoot) liveRoot.parentNode.removeChild(liveRoot);
    var liveStyle = document.getElementById(STYLE_ID);
    if (liveStyle) liveStyle.parentNode.removeChild(liveStyle);
  }
