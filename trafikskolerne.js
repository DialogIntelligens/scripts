...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function sendMessageToIframe() {
    ...
    var messageData = {
      ...
      chatbotID: "trafikskolerne",
      pagePath: window.location.href,
      statestikAPI: "https://flowise-j0lr.onrender.com/api/v1/prediction/13f75d53-7444-4371-8135-bb400db1890c",
      SOCKET_SERVER_URL: "https://flowise-j0lr.onrender.com/",
      apiEndpoint: "https://flowise-j0lr.onrender.com/api/v1/prediction/b8cfa042-619f-4f12-9ecb-9e9f88fd11af",
      fordelingsflowAPI: "",
      flow2Key: "sadsads",
      flow2API: "",
      flow3Key: "asdsad",
      ...
      titleLogoG: "https://dialogintelligens.dk/wp-content/uploads/2024/04/headerLogo.png",
      headerLogoG: "https://dialogintelligens.dk/wp-content/uploads/2024/04/logo-4.png",
      themeColor: "#a62734",
      headerTitleG: "Virtuel assistent",
      headerSubtitleG: "Jeg er en kunstig intelligent chatbot med information om vores køreskoler, priser, ovs. Ved at bruge denne chatbot accepterer du, at samtalen kan gemmes og behandles. Læs mere i vores privatlivspolitik.",
      titleG: "Trafikskolernes AI",
