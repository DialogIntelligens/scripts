document.addEventListener('DOMContentLoaded', function() {
  ...
  function initChatbot() {
    ...
    function sendMessageToIframe() {
      ...
      statestikAPI: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/7339a778-2228-480c-b987-7323f7011b06",
      apiEndpoint: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/8443bc27-dea5-4365-8429-afa41fefb3ed",
      fordelingsflowAPI: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/a10175af-3214-484b-ba46-ea6edbb22bb6",
      flow2Key: "",
      flow2API: "",
      flow3Key: "product",
      flow3API: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/7227e057-d821-4501-9635-4865a3ed644c",
      flow4API: "",
      flow4Key: "",
      ...
      firstMessage: "Hej, jeg er din digitale wingman eller -woman 😉 Mangler du hjælp? Så spørg løs om produkter, anbefalinger eller bare nogle solide tips & tricks – Jeg ved, hvad der rykker (og vibrerer) 💪",
    ...
    function showPopup() {
      ...
      const popupText = "Har du brug for hjælp? 🍆 Jeg kan guide dig til det helt rigtige sexlegetøj – uanset hvad du er til. Jeg kan altid hjælpe!";
