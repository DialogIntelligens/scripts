...
function initChatbot() {
  // Check if on excluded URL - don't load chatbot on signup page
  if (window.location.href.includes('shop.pursico.com/signup')) {
    console.log("Chatbot disabled on signup page.");
    return;
  }
