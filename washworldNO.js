...
// Function to toggle the pulse animation
  ...
  function sendMessageToIframe() {
    ...
    var messageData = {
      ...
      chatbotID: "washworldno",
      pagePath: window.location.href,
      statestikAPI: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/8cde4a03-08c1-4ce7-952b-e4e1509140b0",
      apiEndpoint: "https://den-utrolige-snebold.onrender.com/api/v1/prediction/58fd2fcb-45a5-43b9-93bc-05f75acfe1dd",
      fordelingsflowAPI: "",
      flow2Key: "",
      flow2API: "",
      flow3Key: "",
      ...
      themeColor: "#3ac165",
      headerTitleG: "Wish Wash, vår virtuelle assistent",
      headerSubtitleG: "Her skriver du med vår chatbot, som er basert på kunstig intelligens. Samtaler med chatboten kan lagres og brukes for å forbedre funksjonen. Les mer i vår personvernerklæring. Får du ikke svar på spørsmålene dine her, er du velkommen til å kontakte vår kundeservice på kundeservice@washworld.no.",
      titleG: "Wash World",
...
function toggleChatWindow() {
  ...
  var gifUrls = [
    'https://image-hosting-pi.vercel.app/washworld-no.gif',
    'https://image-hosting-pi.vercel.app/washworld-no.gif'
