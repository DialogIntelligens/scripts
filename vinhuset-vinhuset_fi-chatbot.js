...
setInterval(checkForPurchase, 15000); // Check every 15 seconds
    ...
    function sendMessageToIframe() {
      ...
      flow4KnowledgebaseIndex: "vinhuset-pro-fi",
      apiFlowKnowledgebaseIndex: "vinhuset-alt-fi",
      websiteOverride: "",
      languageOverride: "",
      valutaOverride: "",
      customVar1: "",
      ...
      freshdeskSubmitErrorText: "Tapahtui virhe tiedustelun lähettämisessä. Yritä uudelleen.",
      ...
      headerTitleG: "ViiniBotti – Tekoälyapuri",
      headerSubtitleG: "Keskustelet tekoälyn kanssa. Käyttämällä tätä chatbottia hyväksyt, että virheitä voi esiintyä ja että keskustelu voidaan tallentaa ja käsitellä. Lue lisää tietosuojakäytännöstämme.",
      subtitleLinkText: "",
      subtitleLinkUrl: "",
        
      titleG: "ViiniBotti",
      firstMessage: "Hei 😊 Voit kysyä minulta mitä tahansa – aina tuotteista yleisiin kysymyksiin, tilauksen tilaan tai vinkkeihin ja nikseihin juomien ja tarvikkeiden suhteen 🍾🍷",
...
function trackChatbotOpen() {
  ...
  .catch(function(error) {
    ...
    function showPopup() {
      ...
      const popupText = "Voin suositella viinejä, vastata kysymyksiin ja etsiä tilauksia🍷";
